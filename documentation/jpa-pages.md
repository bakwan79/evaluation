...
public EvaluationPage<Beer> list(EvaluationPageable pagination) {
  return EvaluationPages.from(
      beers.findAll(EvaluationPages.from(pagination, Sort.by(Sort.Direction.ASC, "name"))),
      BeerEntity::toDomain
    );
}
```
