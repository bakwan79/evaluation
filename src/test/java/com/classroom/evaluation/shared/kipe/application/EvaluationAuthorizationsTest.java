...
import static com.classroom.evaluation.shared.kipe.domain.RolesAccessesFixture.*;

import java.util.List;
import java.util.stream.Stream;
import com.classroom.evaluation.UnitTest;
import com.classroom.evaluation.shared.authentication.application.UnknownAuthenticationException;
...
import com.classroom.evaluation.shared.kipe.domain.RolesAccessesFixture.TestResource;
...
@UnitTest
class EvaluationAuthorizationsTest {

  private static final EvaluationAuthorizations authorizations = new EvaluationAuthorizations(List.of(rolesAccesses()));
